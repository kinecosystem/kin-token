...
contract KinTokenSale is Ownable, TokenHolder {
    ...
    function initTokenGrants() private onlyOwner {
        ...
        tokenGrants[KIN_FOUNDATION_ADDRESS] = TokenGrant(60 * MAX_TOKENS.div(100).mul(TOKEN_DECIMALS), 0, 0, 3 years, 1 days, 0);

        // Kik, 30%
        tokenGrantees.push(KIK_ADDRESS);
        tokenGrants[KIK_ADDRESS] = TokenGrant(30 * MAX_TOKENS.div(100).mul(TOKEN_DECIMALS), 0, 0, 120 weeks, 12 weeks, 100);
    }
